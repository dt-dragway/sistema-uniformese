    ...
    <div className="loading-screen">
      <div className="loading-container">
        ...
        <div className="loading-content">
          <h2 className={`status-message status-${status}`}>{getStatusMessage()}</h2>
          ...
          {status === 'connecting' && <p className="loading-hint">Intentando conectar al servidor API...</p>}

          {status === 'verifying' && <p className="loading-hint">Verificando servicios del servidor...</p>}
        </div>
