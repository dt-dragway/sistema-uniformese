import { Container, Paper, Typography, Box, Grid, Divider, Chip, Card, CardContent, Stack } from '@mui/material';
import { Info, Code, Business, Email, GitHub, Speed, Build, Copyright } from '@mui/icons-material';
