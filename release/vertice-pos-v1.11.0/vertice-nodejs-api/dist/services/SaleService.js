...
const saleWithRelations = client_1.Prisma.validator()({
    include: {
...
class SaleService {
    ...
    getSaleByTicketNumber(ticketNumber) {
        return __awaiter(this, void 0, void 0, function* () {
            return prisma.sale.findUnique({
                where: { ticketNumber },
                include: {
    ...
    createSale(saleData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { items, payments, customerId, cashRegisterSessionId, pendingRecharges, pendingCashAdvances } = saleData, saleInfo = __rest(saleData, ["items", "payments", "customerId", "cashRegisterSessionId", "pendingRecharges", "pendingCashAdvances"]);
            ...
            return prisma.$transaction((tx) => __awaiter(this, void 0, void 0, function* () {
                ...
                const newSale = yield tx.sale.create({
                    data: Object.assign(Object.assign({}, saleInfo), { ticketNumber,
                        cashRegisterSessionId, customerId: customerId, items: {
                            ...
                            create: otherPayments.map((p) => {
                                ...
                                return ({
                                    method: p.method,
                                    amount: p.amount,
                                    reference: (_a = p.reference) !== null && _a !== void 0 ? _a : null,
                                });
                            }),
                        } }),
                    include: {
                ...
                if (pendingRecharges && pendingRecharges.length > 0) {
                    for (const rechargeData of pendingRecharges) {
                        ...
                        const lastRecharge = yield tx.recharge.findFirst({
    ...
    cancelSale(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return prisma.$transaction((tx) => __awaiter(this, void 0, void 0, function* () {
                const saleToCancel = yield tx.sale.findUnique({
                    where: { id },
                    include: { items: true },
                });
                ...
                const cancelledSale = yield tx.sale.update({
                    where: { id: id },
                    ...
                    for (const payment of cancelledSale.payments) {
                        yield tx.cashMovement.create({
                            data: {
                                ...
                                type: 'anulacion',
                                amountUsd: -payment.amount,
                                amountBs: -(payment.amount * ((currentRate === null || currentRate === void 0 ? void 0 : currentRate.rate) || 1)), // Use negative to reverse
                                paymentMethod: payment.method,
     ...
     */
    checkDuplicateReference(reference, paymentMethods) {
        return __awaiter(this, void 0, void 0, function* () {
